...
- Faithfulness of an Additive Explanator, FAE: assesses the rates an additive feature importance explainer preserves its primary property of local accuracy, i.e., the model prediction should be reconstructed by the summation of the importance values. The ratio indicates the explanations' share that preserved the local accuracy.
